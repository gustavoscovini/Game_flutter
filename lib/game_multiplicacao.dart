...
class GameApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: GameMultiplicacao(),
    );
  }
}

class GameMultiplicacao extends StatefulWidget {
  @override
  _GameMultiplicacaoState createState() => _GameMultiplicacaoState();
}

class _GameMultiplicacaoState extends State<GameMultiplicacao> {
